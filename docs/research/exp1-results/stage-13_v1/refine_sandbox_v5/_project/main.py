...
def simulate_task_completion_rate(condition_name, hyperparams):
    """
...
def run_experiment(condition_name, seed, harness):
    ...
    task_completion_rate = simulate_task_completion_rate(condition_name, HYPERPARAMETERS)
