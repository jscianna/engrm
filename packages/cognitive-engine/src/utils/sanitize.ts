...
import type { CodingTrace, Approach, TraceContext } from '../types.js';
 ...
 */
function sanitizeContext(context: TraceContext): TraceContext {
  return {
    ...context,
 ...
 */
function sanitizeApproach(approach: Approach): Approach {
  return {
    ...approach,
 ...
 */
export function sanitizeTrace(trace: CodingTrace): CodingTrace {
  return {
    ...trace,
