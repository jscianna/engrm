 ...
 */
export function isProfileStale(profile: CodebaseProfile, thresholdMs?: number): boolean {
 ...
 */
export function formatStalenessHint(profile: CodebaseProfile): string | null {
  if (!isProfileStale(profile)) return null;
