 ...
 */
function sortByPriority(sections) {
 ...
 */
function formatSectionXml(section) {
 ...
 */
function formatSectionTerse(section) {
 ...
 */
export function formatContextForModel(sections, adapter, totalBudget) {
